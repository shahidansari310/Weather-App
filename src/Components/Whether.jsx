...
const Whether = () => {
  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md mx-auto my-6 p-5 sm:p-8 rounded-2xl bg-white/10 backdrop-blur-md flex flex-col shadow-lg border border-white/30">
      <div className="text-center mb-4 text-xl sm:text-2xl font-bold text-white">
        Live Weather
      </div>
      ...
      {data ? (
        ...
        <div className="text-center text-white mt-4 text-lg font-bold">
